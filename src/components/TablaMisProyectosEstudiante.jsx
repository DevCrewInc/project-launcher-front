    ...
    return(
        ...
        <tr key={inscripcion.proyecto._id}>
            ...
            <td className = "flex justify-center items-center space-x-2">
                {inscripcion.estado==="PENDIENTE"|| inscripcion.estado==="RECHAZADA"||inscripcion.proyecto.faseProyecto==="TERMINADO"||inscripcion.proyecto.estadoProyecto==="INACTIVO"?(<><i className="text-gray-400 far py-3 far fa-clock fa-lg"></i></>):(<>
